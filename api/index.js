...
var require_dist = __commonJS({
  'node_modules/@asteasolutions/zod-to-openapi/dist/index.cjs'(exports2) {
    ...
    function isZodType(schema, typeName) {
      var _a
      return (
        ((_a = schema === null || schema === void 0 ? void 0 : schema._def) === null || _a === void 0
          ? void 0
    ...
    function extendZodWithOpenApi2(zod) {
      ...
      zod.ZodType.prototype.openapi = function (refOrOpenapi, metadata) {
        ...
        const _g = openapi !== null && openapi !== void 0 ? openapi : {},
          { param } = _g,
          restOfOpenApi = __rest(_g, ['param'])
        const _internal = Object.assign(
          Object.assign({}, (_a = this._def.openapi) === null || _a === void 0 ? void 0 : _a._internal),
          typeof refOrOpenapi === 'string' ? { refId: refOrOpenapi } : void 0
        )
        const resultMetadata = Object.assign(
          Object.assign(
            Object.assign({}, (_b = this._def.openapi) === null || _b === void 0 ? void 0 : _b.metadata),
            restOfOpenApi
          ),
          ((_d = (_c = this._def.openapi) === null || _c === void 0 ? void 0 : _c.metadata) === null || _d === void 0
            ? void 0
            : _d.param) || param
            ? {
                param: Object.assign(
                  Object.assign(
                    {},
                    (_f = (_e = this._def.openapi) === null || _e === void 0 ? void 0 : _e.metadata) === null ||
                      _f === void 0
                      ? void 0
                      : _f.param
                  ),
        ...
        const result = new this.constructor(
          Object.assign(Object.assign({}, this._def), {
            openapi: Object.assign(
              Object.assign({}, Object.keys(_internal).length > 0 ? { _internal } : void 0),
              Object.keys(resultMetadata).length > 0 ? { metadata: resultMetadata } : void 0
            )
          })
        )
        if (isZodType(this, 'ZodObject')) {
          ...
          result.extend = function (...args) {
            ...
            extendedResult._def.openapi = {
              _internal: {
                extendedFrom: (
                  (_b2 = (_a2 = this._def.openapi) === null || _a2 === void 0 ? void 0 : _a2._internal) === null ||
                  _b2 === void 0
                    ? void 0
                    : _b2.refId
                )
                  ? {
                      refId:
                        (_d2 = (_c2 = this._def.openapi) === null || _c2 === void 0 ? void 0 : _c2._internal) ===
                          null || _d2 === void 0
                          ? void 0
                          : _d2.refId,
                      schema: this
                    }
                  : (_f2 = (_e2 = this._def.openapi) === null || _e2 === void 0 ? void 0 : _e2._internal) === null ||
                      _f2 === void 0
                    ? void 0
                    : _f2.extendedFrom
              },
      ...
      zod.ZodObject.prototype.deepPartial = function () {
        ...
        Object.entries(resultShape).forEach(([key, value]) => {
          var _a, _b
          value._def.openapi =
            (_b = (_a = initialShape[key]) === null || _a === void 0 ? void 0 : _a._def) === null || _b === void 0
              ? void 0
              : _b.openapi
        })
    ...
    function getOpenApiMetadata(zodSchema) {
      var _a, _b
      return omitBy(
        (_b = (_a = zodSchema._def.openapi) === null || _a === void 0 ? void 0 : _a.metadata) !== null && _b !== void 0
          ? _b
          : {},
        isUndefined
      )
    ...
    var OpenAPIRegistry2 = class {
      ...
      get definitions() {
        ...
        const parentDefinitions =
          (_b = (_a = this.parents) === null || _a === void 0 ? void 0 : _a.flatMap((par) => par.definitions)) !==
            null && _b !== void 0
            ? _b
            : []
        ...
        const schemaWithMetadata = schemaWithRefId.openapi(
          Object.assign(Object.assign({}, currentMetadata), {
            param: Object.assign(
              Object.assign(
                {},
                currentMetadata === null || currentMetadata === void 0 ? void 0 : currentMetadata.param
              ),
              {
                name:
                  (_c =
                    (_b = currentMetadata === null || currentMetadata === void 0 ? void 0 : currentMetadata.param) ===
                      null || _b === void 0
                      ? void 0
    ...
    var Metadata = class {
      ...
      static getParamMetadata(zodSchema) {
        ...
        return {
          _internal: metadata === null || metadata === void 0 ? void 0 : metadata._internal,
          metadata: Object.assign(
            Object.assign({}, metadata === null || metadata === void 0 ? void 0 : metadata.metadata),
            {
              // A description provided from .openapi() should be taken with higher precedence
              param: Object.assign(
                { description: zodDescription },
                (_b = metadata === null || metadata === void 0 ? void 0 : metadata.metadata) === null || _b === void 0
                  ? void 0
                  : _b.param
              )
            }
    ...
    var ObjectTransformer = class {
      transform(zodSchema, defaultValue, mapNullableType, mapItem) {
        var _a
        const extendedFrom =
          (_a = Metadata.getInternalMetadata(zodSchema)) === null || _a === void 0 ? void 0 : _a.extendedFrom
    ...
    var StringTransformer = class {
      transform(zodSchema, mapNullableType) {
        ...
        const maxLength = Number.isFinite(zodSchema.minLength)
          ? (_b = zodSchema.minLength) !== null && _b !== void 0
            ? _b
            : void 0
          : void 0
        const minLength = Number.isFinite(zodSchema.maxLength)
          ? (_c = zodSchema.maxLength) !== null && _c !== void 0
            ? _c
            : void 0
          : void 0
    ...
    var OpenAPIGenerator = class {
      ...
      buildComponents() {
        ...
        return Object.assign(Object.assign({}, rawComponents), {
          schemas: Object.assign(
            Object.assign({}, (_a = rawComponents.schemas) !== null && _a !== void 0 ? _a : {}),
            this.schemaRefs
          ),
          parameters: Object.assign(
            Object.assign({}, (_b = rawComponents.parameters) !== null && _b !== void 0 ? _b : {}),
            this.paramRefs
          )
        })
      }
      ...
      getParameterRef(schemaMetadata, external) {
        ...
        const parameterMetadata =
          (_a = schemaMetadata === null || schemaMetadata === void 0 ? void 0 : schemaMetadata.metadata) === null ||
          _a === void 0
            ? void 0
            : _a.param
        const existingRef = (
          (_b = schemaMetadata === null || schemaMetadata === void 0 ? void 0 : schemaMetadata._internal) === null ||
          _b === void 0
            ? void 0
            : _b.refId
        )
          ...
          : void 0
        if (
          !((_d = schemaMetadata === null || schemaMetadata === void 0 ? void 0 : schemaMetadata._internal) === null ||
          _d === void 0
            ? void 0
            : _d.refId) ||
          !existingRef
        ...
        if (
          ...
          ((external === null || external === void 0 ? void 0 : external.name) &&
            existingRef.name !== (external === null || external === void 0 ? void 0 : external.name))
        ) {
      ...
      generateInlineParameters(zodSchema, location) {
        ...
        const parameterMetadata =
          (_a = metadata === null || metadata === void 0 ? void 0 : metadata.metadata) === null || _a === void 0
            ? void 0
            : _a.param
        ...
        if (isZodType(zodSchema, 'ZodObject')) {
          ...
          const parameters = Object.entries(propTypes).map(([key, schema]) => {
            ...
            const innerParameterMetadata =
              (_a2 = innerMetadata === null || innerMetadata === void 0 ? void 0 : innerMetadata.metadata) === null ||
              _a2 === void 0
                ? void 0
                : _a2.param
            if (
              (innerParameterMetadata === null || innerParameterMetadata === void 0
                ? void 0
            ...
            if (
              ...
              throw new ConflictError(
                `Conflicting location for parameter ${(_b = innerParameterMetadata.name) !== null && _b !== void 0 ? _b : key}`,
                {
                  key: 'in',
      ...
      generateSimpleSchema(zodSchema) {
        ...
        const newMetadata = omitBy(
          ...
          (value, key) => value === void 0 || objectEquals(value, schemaRef[key])
        )
        if (newMetadata.type) {
          return {
      ...
      getBodyContent(content) {
        return mapValues(content, (config2) => {
          ...
          const { schema: configSchema } = config2,
            rest = __rest(config2, ['schema'])
...
var Context = class {
  ...
  html = (html2, arg, headers) => {
    ...
    return typeof html2 === 'object'
      ? resolveCallback(html2, HtmlEscapedCallbackPhase.Stringify, false, {}).then(res)
      : res(html2)
  }
  /**
...
var Hono = class _Hono {
  ...
  */
  ...
  request = (input2, requestInit, Env, executionCtx) => {
    ...
    return this.fetch(
      new Request(/^https?:\/\//.test(input2) ? input2 : `http://localhost${mergePath('/', input2)}`, requestInit),
      Env,
      executionCtx
    )
  }
...
var ArtistAPIResponseModel = external_exports
  .object({
    artistId: external_exports.string(),
    name: external_exports.string(),
    subtitle: external_exports.string(),
...
var ArtistModel = external_exports.object({
  ...
  similarArtists: external_exports
    .array(
      external_exports.object({
        id: external_exports.string(),
        name: external_exports.string(),
...
var PlaylistAPIResponseModel = external_exports
  .object({
    id: external_exports.string(),
    title: external_exports.string(),
    subtitle: external_exports.string(),
